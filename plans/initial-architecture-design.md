...
### 1. `normalizacja_liczebnikow/diacritics.py`
...
### 2. `normalizacja_liczebnikow/mappings.py`
...
### 3. `normalizacja_liczebnikow/parser.py`
...
### 4. `normalizacja_liczebnikow/normalizer.py`
...
### 5. `normalizacja_liczebnikow/__init__.py`
...
- Create `normalizacja_liczebnikow/__init__.py`
- Create `normalizacja_liczebnikow/diacritics.py` with diacritic removal and comparison normalization
- Create `normalizacja_liczebnikow/mappings.py` with nominative cardinal forms only
- Create `normalizacja_liczebnikow/parser.py` with the state machine parser
- Create `normalizacja_liczebnikow/normalizer.py` with the main function
