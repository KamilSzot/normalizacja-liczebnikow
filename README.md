...
```python
from normalizacja_liczebnikow import normalize_numbers
...
```python
from normalizacja_liczebnikow import normalize_text
...
```python
from normalizacja_liczebnikow import normalize
